  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-1 text-center ">
      <div
        className={`${
          imgLoaded
            ? "before:absolute before:inset-0 before:z-[49] before:mx-auto before:w-[200px] before:animate-pulse before:rounded-[20px] before:bg-[#181818] before:content-['']"
            : ""
        } relative w-full`}
      >
        <img
          ...
          className={`${
            imgLoaded ? "invisible" : ""
          } mx-auto h-[250px] w-[200px] rounded-[20px] border-2 border-[#252229] object-cover transition-all hover:cursor-pointer hover:border-2 hover:border-white lg:h-[200px] 2xl:h-[300px]`}
          src={celebImgPath}
          alt="actor img"
          loading="lazy"
          onClick={() => {
